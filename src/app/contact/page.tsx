                ...
                <div>
                  ...
                  <div className="space-y-8">
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-start gap-3">
                          ...
                          <a
                            ...
                            className="text-night/70 text-sm hover:text-sage transition-colors duration-200"
                          >
                        ...
                        <li className="flex items-center gap-3">
                          ...
                          <a href="tel:+41794176737" className="text-night/70 text-sm hover:text-sage transition-colors duration-200">
                            079 417 67 37
                          </a>
                        </li>
                        <li className="flex items-center gap-3">
                          <Mail size={18} className="shrink-0 text-sage" />
                          <a href="mailto:info@cieletterre.ch" className="text-night/70 text-sm hover:text-sage transition-colors duration-200">
                            info@cieletterre.ch
                          </a>
                        </li>
                      </ul>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm">
                      ...
                      <p className="text-night/50 text-sm mb-4">Atelier TerreColorée</p>
                      <ul className="space-y-3">
                        <li className="flex items-start gap-3">
                          <MapPin size={18} className="mt-0.5 shrink-0 text-sage" />
                          <a
                        ...
                        <li className="flex items-center gap-3">
                          <Phone size={18} className="shrink-0 text-sage" />
                          <a href="tel:+41798584155" className="text-night/70 text-sm hover:text-sage transition-colors duration-200">
                            079 858 41 55
                          </a>
                        </li>
                        <li className="flex items-center gap-3">
                          <Mail size={18} className="shrink-0 text-sage" />
                          <a href="mailto:mah@terrecoloree.ch" className="text-night/70 text-sm hover:text-sage transition-colors duration-200">
                            mah@terrecoloree.ch
                          </a>
                        </li>
                      </ul>
